...
export const ExtraEmailIcon: React.FC<IconProps> = ({ size = 48, color = '#2C3D94' }) => {
  return (
    <svg width={size} height={size} viewBox='0 0 55 48' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
